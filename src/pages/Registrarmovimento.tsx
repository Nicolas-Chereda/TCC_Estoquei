...
import { type MovimentoTipo } from "../types/User";

const registroSchema = z.object({
    produto: z
        .string()
        .min(1, { message: "Informe o produto." }),
    marca: z.string()
        .min(1, { message: "Informe a marca." }),
    codigo: z
    ...
    estoque: z
        .number({message: "informe uma quantidade de estoque válida"}),
    entrasai: z.string()
            .min(1, { message: "informe se entrou ou saiu." }),
});
