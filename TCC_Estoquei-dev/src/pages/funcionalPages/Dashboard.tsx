            ...
            <div className={estilos.cards}>
                ...
                <div className={estilos.card}>
                    <div className={estilos.card__content}>
                        <div className={estilos.texto_card}>
                            VENDAS <AiOutlineLoading3Quarters />
                        </div>
                    </div>
                </div>
                {/*---------------- Card 2 ----------------*/}
                <div className={estilos.card}>
                    <div className={estilos.card__content}>
                        <div className={estilos.texto_card}>
                            ESTOQUE <AiOutlineLoading3Quarters />
                        </div>
                    </div>
                </div>
                {/*---------------- Card 3 ----------------*/}
                <div className={estilos.card}>
                    <div className={estilos.card__content}>
                        <div className={estilos.texto_card}>
                            REGISTRO <AiOutlineLoading3Quarters />
                        </div>
                    </div>
                </div>
                ...
                <div className={estilos.quadrado} onClick={IrParaHistorico}>
                    <div className={estilos.quadrado_content}>
                        <div className={estilos.texto_quadrado}>
                            HISTÓRICO <AiOutlineLoading3Quarters />
                        </div>
                    </div>
                </div>
                ...
                <div className={estilos.quadrado2}>
                    <div className={estilos.quadrado_content}>
                        <div className={estilos.texto_quadrado}>
                            RELÁTORIOS <AiOutlineLoading3Quarters />
                        </div>
                    </div>
                </div>
                ...
                <div className={estilos.quadrado4}>
                    <div className={estilos.quadrado_content}>
                        <div className={estilos.texto_quadrado}>
                            FORNECEDORES <AiOutlineLoading3Quarters />
                        </div>
                    </div>
                </div>
            </div>
